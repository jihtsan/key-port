...
# Local ad-hoc signing proves bundle integrity. Production iCloud entitlements
# require a Developer ID/App ID profile and are intentionally not forged here.
