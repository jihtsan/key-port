...
enum UserFacingText {
    ...
    static func localized(_ text: String) -> String {
        ...
        if text.hasPrefix("Host key changed for "), text.hasSuffix(". Password authentication was blocked.") {
            ...
            return "以下算法的主机密钥已变更：\(algorithms)。密码登录验证已被阻止。"
        }
        ...
        case "Connection details changed. Password SSH was verified; check key authorization again.": "连接信息已变更。密码登录已验证，请重新检测免密。"
        case "Password SSH verified. This Mac key can now be authorized.": "密码登录已验证，现在可以为当前 Mac 启用免密。"
        case "Host key confirmed from the current network response.": "已根据当前网络响应确认主机密钥。"
        case "This Mac key is ready for authorization.": "当前 Mac 的密钥已就绪，可以启用免密。"
        case "This Mac authorization was revoked.": "此 Mac 的授权已撤销。"
        case "The configured SSH identity changed. Check this connection before authorizing it.": "已配置的 SSH 身份密钥发生变化，请在启用免密前检查此连接。"
        case "Passwordless SSH authentication succeeded.": "免密登录验证成功。"
        case "The current Mac key is not authorized.": "当前 Mac 尚未启用免密。"
        case "Host key confirmation is required.": "需要确认主机密钥。"
        case "Fetching host keys before the key login check.": "免密检测前正在获取主机密钥。"
        case "Review the host key fingerprints before authentication.": "身份验证前，请核对主机密钥指纹。"
        case "Enter and test a server password before checking Password SSH.": "进行密码登录验证前，请输入并验证服务器密码。"
        case "Password SSH authentication succeeded.": "密码登录验证成功。"
        case "Server password authentication succeeded.": "密码登录验证成功。"
        ...
        case "Server password authentication succeeded during authorization.": "启用免密时，密码登录验证成功。"
        case "The key was installed, but passwordless SSH verification failed.": "公钥已安装，但免密登录验证失败。"
        case "Passwordless SSH authentication succeeded after authorization.": "公钥授权后，免密登录验证成功。"
        ...
        case "Run a local check before relying on this authorization.": "使用此免密授权前，请先进行本地检测。"
        default: text
        }
    }
    ...
    static func localizedError(_ error: Error) -> String {
        ...
        logger.error("Normalizing an unrecognized system error for display")
